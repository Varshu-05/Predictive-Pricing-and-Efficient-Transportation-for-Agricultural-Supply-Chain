    ...
    class Buyer:
        ...
        def extract(self):
            ...
            if self.season == "Pre-Monsoon":
                self.data = pd.read_csv(r"C:\Users\Lohesh\Desktop\Fair Price Decisor\Selling\Selling\pages\dataset\pre.csv")
                self.mean = self.data[self.data["commodity_name"]
                                      == self.crop]["Predicted_price"].mean()

            if self.season == "Post-Monsoon":
                self.data = pd.read_csv(r"C:\Users\Lohesh\Desktop\Fair Price Decisor\Selling\Selling\pages\dataset\post.csv")
                self.mean = self.data[self.data["commodity_name"]
                                      == self.crop]["Predicted_price"].mean()

            if self.season == "Monsoon":
                self.data = pd.read_csv(r"C:\Users\Lohesh\Desktop\Fair Price Decisor\Selling\Selling\pages\dataset\mon.csv")
                self.mean = self.data[self.data["commodity_name"]
                                      == self.crop]["Predicted_price"].mean()
